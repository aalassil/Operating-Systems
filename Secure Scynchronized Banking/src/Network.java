...
public class Network extends Thread {
    ...
    //new semaphores added:
    private static Semaphore semInBufferNotEmpty = new Semaphore(0);
    private static Semaphore semInBufferNotFull = new Semaphore(10);
    
    private static Semaphore semOutBufferNotEmpty = new Semaphore(0);
    private static Semaphore semOutBufferNotFull = new Semaphore(10);
